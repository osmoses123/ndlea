...
<head>
  ...
  <title>  @yield('pagetitle') - Public Complaints Commission | File Management System</title>
  ...
  <link rel="stylesheet" href="{{asset('panel/assets/bundles/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('panel/assets/bundles/bootstrap-timepicker/css/bootstrap-timepicker.min.css')}}">
  <link rel="stylesheet" href="{{asset('panel/assets/bundles/bootstrap-tagsinput/dist/bootstrap-tagsinput.css')}}">

  <link rel="stylesheet" href="{{asset('panel/assets/bundles/summernote/summernote-bs4.css')}}">
  <link rel="stylesheet" href="{{asset('panel/assets/bundles/codemirror/lib/codemirror.css')}}">
  <link rel="stylesheet" href="{{asset('panel/assets/bundles/codemirror/theme/duotone-dark.css')}}">
  <!-- Template CSS -->
...
@yield('admin');
  ...
  <script src="{{asset('panel/assets/js/page/forms-advanced-forms.js')}}"></script>
   ...
   <!-- JS Libraies -->
   <script src="{{asset('panel/assets/bundles/summernote/summernote-bs4.js')}}"></script>
   <script src="{{asset('panel/assets/bundles/codemirror/lib/codemirror.js')}}"></script>
   <script src="{{asset('panel/assets/bundles/codemirror/mode/javascript/javascript.js')}}"></script>
   <script src="{{asset('panel/assets/bundles/jquery-selectric/jquery.selectric.min.js')}}"></script>
   <script src="{{asset('panel/assets/bundles/ckeditor/ckeditor.js')}}"></script>
   <!-- Page Specific JS File -->
   <script src="{{asset('panel/assets/js/page/ckeditor.js')}}"></script>
  ...
  <script src="{{asset('panel/assets/js/page/form-wizard.js')}}"></script>


  <script src="{{asset('panel/assets/bundles/jquery-steps/jquery.steps.min.js')}}"></script>
