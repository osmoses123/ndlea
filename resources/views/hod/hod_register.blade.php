          ...
          <div class="row">
            <div class="col-12 col-sm-10 offset-sm-2 col-md-8 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-4">
              <div class="card card-primary">
                <div class="card-header" style="text-align:right; text-transform:uppercase;">
                ...
                <div class="card-body">
                    ...
                    @endif
                  <form method="post" action="{{ route('hod.create_hod') }}" class="needs-validation" novalidate="">
                @csrf
              ...
              I have an account Already <a href="{{ route('hod.login') }}">Login</a>
              </div>
            </div>
          </div>
        </div>
